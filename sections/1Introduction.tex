...
This paper focuses on field-level requirements in protocol standards. Many actionable
...
field $F$ must satisfy action or constraint $A$ under condition $C$. This form
...
CoAP. \tool{} produced 240 submitted conformance-deviation reports; maintainers
confirmed 85, rejected 4 as false positives, and 151 remain pending.
...
\begin{itemize}[leftmargin=*]
  ...
  analysis into maintainer-oriented defect reports and reproduction
  ...
  QUIC, and CoAP, producing 240 submitted reports, 85 maintainer-confirmed
  reports, 4 rejected false positives, 151 pending reports, and two
