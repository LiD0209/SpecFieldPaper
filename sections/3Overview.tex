...
exception rules. \tool{} first locates protocol variables and their associated
constraints in the standard, and then extracts field-level rules from this
material. This design avoids asking an LLM to directly judge defects from large
blocks of standard text. Instead, it first derives well-scoped checking rules
that provide the basis for subsequent code-conformance analysis.
